  ...
  return (
    <form onSubmit={onSubmitHandler}>
      ...
      <div className='w-full mb-2'>
        ...
        <input onChange={(e) => setName(e.target.value)} value={name} className='w-full max-w-[350px] px-3 py-2' type="text" placeholder='Type here' required />
      </div>

      <div className='w-full mb-2'>
        <p className='mb-1'>Product description</p>
        <textarea onChange={(e) => setDescription(e.target.value)} value={description} className='w-full max-w-[350px] px-3 py-2' type="text" placeholder='Write content here' required />
      </div>

      <div className='flex flex-col sm:flex-row w-full gap-2 sm:gap-8 mb-2'>
        <div>
      ...
      <button type='submit' disabled={isAdding} className='w-28 py-3 mt-4 bg-black text-white'>{isAdding ? 'Adding...' : 'Add'}</button>
